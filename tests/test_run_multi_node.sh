...
echo "./tests/single_player.sh $DEFAULT_LOCAL_NETWORK_URL $DEFAULT_CHAIN_ID $BLACK_JACK_APP_ID"
echo ""
...
echo "./tests/single_player.sh $PLAYER_A_LOCAL_NETWORK_URL $PLAYER_A_CHAIN_ID $BLACK_JACK_APP_ID"
echo ""
...
echo "./tests/single_player.sh $PLAYER_B_LOCAL_NETWORK_URL $PLAYER_B_CHAIN_ID $BLACK_JACK_APP_ID"
echo ""
