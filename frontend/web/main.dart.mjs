...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1433: (x0,x1) => new WebSocket(x0,x1),
      _1434: (x0,x1) => x0.send(x1),
      _1435: (x0,x1,x2) => x0.close(x1,x2),
      _1436: (x0,x1) => x0.close(x1),
      _1437: x0 => x0.close(),
      _1469: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1470: (x0,x1,x2) => x0.fetch(x1,x2),
      ...
      _1489: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1490: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1504: (x0,x1) => x0.key(x1),
      _1505: (s, m) => {
        try {
      ...
      _2365: (x0,x1) => { x0.preload = x1 },
      _2366: x0 => x0.buffered,
      _2369: x0 => x0.currentTime,
      _2370: (x0,x1) => { x0.currentTime = x1 },
      _2371: x0 => x0.duration,
      _2376: (x0,x1) => { x0.playbackRate = x1 },
      _2389: (x0,x1) => { x0.volume = x1 },
      _2404: x0 => x0.code,
      _2475: x0 => x0.length,
      _3445: () => globalThis.window,
      _3770: x0 => x0.localStorage,
      _3946: x0 => x0.data,
      _4106: x0 => x0.length,
      _4323: () => globalThis.WebSocket.OPEN,
      _4324: () => globalThis.WebSocket.CLOSING,
      _4325: () => globalThis.WebSocket.CLOSED,
      _4327: x0 => x0.readyState,
      _4336: x0 => x0.protocol,
      _4340: (x0,x1) => { x0.binaryType = x1 },
      _4343: x0 => x0.code,
      _4344: x0 => x0.reason,
      _7051: x0 => x0.signal,
      _7143: () => globalThis.document,
      _9041: x0 => x0.value,
      _9043: x0 => x0.done,
      _9748: x0 => x0.url,
      _9750: x0 => x0.status,
      _9752: x0 => x0.statusText,
      _9753: x0 => x0.headers,
      _9754: x0 => x0.body,
